...
// epi-addons
    ...
    return declare([Stateful, DestroyableByKey, _ContentContextMixin], {
        ...
        getChartData: function (beginDate, endDate) {
            // summary:
            ...
            when(this.getCurrentContext(), lang.hitch(this, function (context) {
                when(this.store.query({ query: "getchartdata", parent: context.id, beginDate: beginDate, endDate: endDate }), lang.hitch(this, function (data) {
                    def.resolve(data);
                }));
            }));
        ...
        exportData: function (extension, submissionIds, beginDate, endDate, callback) {
            // summary:
