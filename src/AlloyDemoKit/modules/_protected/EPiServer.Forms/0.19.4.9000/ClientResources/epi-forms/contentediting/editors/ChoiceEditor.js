...
// epi-addons
    ...
    return declare([_WidgetListEditor], {
        ...
        // _selectorValueSeparator: [private] String
        //      
        _selectorValueSeparator: ModuleSettings.selectorValueSeparator,
        ...
        _getCheckBoxesCalculatedValue: function (/*Array*/selectors) {
            ...
            return values.join(this._selectorValueSeparator);
        },
        ...
        _setCheckBoxesValue: function (/*Array*/selectors, /*String*/value) {
            ...
            var values = [];
            if (value) {
                values = value.split(this._selectorValueSeparator);
            }
