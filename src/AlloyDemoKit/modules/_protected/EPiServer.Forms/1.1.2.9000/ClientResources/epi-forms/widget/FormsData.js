    ...
    return declare([_Widget, _TemplatedMixin, _WidgetsInTemplateMixin, _ModelBindingMixin], {
        ...
        _onSearch: function () {
            ...
            when(this.model.getCurrentContext(), lang.hitch(this, function (context) {
                ...
                this._updateChart(beginDate, endDate);
                this._refresh({ parent: context.id, beginDate: beginDate, endDate: endDate });
            }));
        },
        ...
        _onExport: function (contentType) {
            ...
            if (selection.length > 0) {
                this.model.exportData(contentType, selection, null, null, hideStandby);
            }
            else {
                var beginDate = epiDateTime.transformDate(this.beginDate.get("value")),
                    endDate = epiDateTime.transformDate(this.endDate.get("value"));

                this.model.exportData(contentType, null, beginDate, endDate, hideStandby);
            }
        },
        ...
        _updateChart: function (beginDate, endDate) {
            // summary:
            ...
            when(this.model.getChartData(beginDate, endDate), lang.hitch(this, function (data) {
