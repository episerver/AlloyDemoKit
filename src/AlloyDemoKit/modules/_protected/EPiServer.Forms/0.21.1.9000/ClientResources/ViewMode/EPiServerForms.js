                        ...
                        if (returnedResult.IsSuccess === true) {
                            ...
                            if (returnedResult.FailInfo && returnedResult.FailInfo.InvalidElement) {
                                ...
                                var $element = $("#" + returnedResult.FailInfo.InvalidElement + "", workingFormInfo.$workingForm),
                                    ...
                                    validatorsInfo = _getElementValidators(workingFormInfo.ValidationInfo, returnedResult.FailInfo.InvalidElement),
                                    validatorInfo = _getValidatorByValidatorType(validatorsInfo, returnedResult.FailInfo.Validator);
