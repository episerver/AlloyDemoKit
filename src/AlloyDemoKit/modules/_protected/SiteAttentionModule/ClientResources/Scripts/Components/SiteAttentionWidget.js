    ...
    return declare("siteattention.components.SiteAttentionWidget", [_Widget, _TemplatedMixin], {
        ...
        _renderUserSupportInfoOnWidgets: function () {
            dojo.when(this.metadatastore.query(), function (metaData) {
                ...
                var element = document.getElementById('siteattention_components_SiteAttentionWidget_0');
                ...
                for (var i = 1; i < 20; i++) {
                    var element = document.getElementById('siteattention_components_SiteAttentionWidget_' + i.toString());
                    if (element != null) {
        ...
        _loadPageDataAndSAScripts: function (pageInformation, properties) {
            dojo.when(this.store.query(pageInformation), function (siteAttentionData) {
                ...
                EPiServerSiteAttentionData.siteAttentionWidgetTag = document.getElementById('siteattention_components_SiteAttentionWidget_0');
